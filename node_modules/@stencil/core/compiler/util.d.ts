...
export declare function generatePreamble(config: BuildConfig, sourceTarget?: SourceTarget): string;
...
export declare function componentRequiresScopedStyles(encapsulation: ENCAPSULATION): boolean;
export declare function pathJoin(config: BuildConfig, ...paths: string[]): string;
