...
export declare function parseComponentDataToModuleFile(config: BuildConfig, manifest: Manifest, manifestDir: string, cmpData: ComponentData): ModuleFile;
export declare function serializeBundles(manifestData: ManifestData, manifest: Manifest): void;
